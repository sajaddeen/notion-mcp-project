...
import { isBrowserEnvironment, timer as _timer, } from '@openai/agents-core/_shims';
...
export class BatchTraceProcessor {
    ...
    exportTriggerRatio = 0.8, } = {}) {
        ...
        if (!isBrowserEnvironment()) {
            ...
            logger.warn('BatchTraceProcessor is not supported in the browser. Traces will not be exported.');
        }
    }
